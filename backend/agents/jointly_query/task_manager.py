...
class AgentTaskManager(InMemoryTaskManager):
    def __init__(self, agent: JointlyQueryAgent, notification_sender_auth: PushNotificationSenderAuth):
        super().__init__()
        self.agent = agent
    ...
    def _validate_request(self, request: Union[SendTaskRequest, SendTaskStreamingRequest]) -> JSONRPCResponse | None:
        ...
        if not utils.are_modalities_compatible(
            task_send_params.acceptedOutputModes, JointlyQueryAgent.SUPPORTED_CONTENT_TYPES
        ):
